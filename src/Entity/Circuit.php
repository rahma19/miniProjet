...
class Circuit
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\EtapeCircuit", mappedBy="circuit_etape", orphanRemoval=true)
     */
    ...
    public function addEtapeCircuit(EtapeCircuit $etapeCircuit): self
    {
        if (!$this->etapeCircuits->contains($etapeCircuit)) {
            ...
            $etapeCircuit->setCircuitEtape($this);
        }
    ...
    public function removeEtapeCircuit(EtapeCircuit $etapeCircuit): self
    {
        if ($this->etapeCircuits->contains($etapeCircuit)) {
            ...
            if ($etapeCircuit->getCircuitEtape() === $this) {
                $etapeCircuit->setCircuitEtape(null);
            }
        }
